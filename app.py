...
if st.button("Ejecutar Análisis de Riesgo"):
    if modelos is None:
        ...
        # 1. Renombrar 'type' a 'type_encoded' (que es lo que pide el modelo)
        df_para_modelo = df_input.rename(columns={'type': 'type_encoded'})
        ...
        # --- A PARTIR DE AQUÍ USAMOS 'df_para_modelo' EN LUGAR DE 'df_input' ---
